...
#define D_MEASURE_REDUCTION 010.0
#define D_MAP_SIZE (100000/D_MEASURE_REDUCTION)

#define D_EFFECT_THRHOLD 2
#define D_SONAR_NOISE_THRHOLD 3000

#define D_EFFECT_RADIUS (300/D_MEASURE_REDUCTION)
...
/**************************************************************************/
    ...
    dirVector dest, pose, move, d_list[] = {
        dirVector(6000/D_MEASURE_REDUCTION, 400/D_MEASURE_REDUCTION, 0),
    };
    vector<int> readings;
